...
const Diplomes = () => {
  ...
  return (
    <div className="body">
        ...
        <h1 className="comic-neue-bold-underline t-center">Mes diplômes</h1>
        {diplomes.map((dip, index) => (
            <div key={index} className="experience">
            <div className="annee-logo">
                <h2 className="comic-neue-regular-underline">{dip.year}</h2>
                <p className="comic-neue-light">
                <img className="logo" src={dip.companyLogo} alt="Logo" />
                </p>
            </div>
            <div className="description-poste">
                <h2 className="comic-neue-regular-underline">{dip.jobTitle}</h2>
                <p className="comic-neue-light">{dip.description}</p>
            </div>
            </div>
        ))}
        </div>
